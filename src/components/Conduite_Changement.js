...
class Conduite_Changement extends React.Component{
    state = {
    expanded: null,
  };
...
Conduite_Changement.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(Conduite_Changement);
