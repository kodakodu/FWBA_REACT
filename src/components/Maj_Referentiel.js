...
class Maj_Referentiel extends React.Component{
    state = {
    expanded: null,
  };
  ...
  handleChange = panel => (event, expanded) => {
    ...
    render(){
        ...
        return(
            <div>
                <h2>Mise à jour du référentiel</h2>
...
Maj_Referentiel.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(Maj_Referentiel);
