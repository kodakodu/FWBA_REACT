  ...
  handleChange = panel => (event, expanded) => {
    ...
    render(){
        ...
        <ExpansionPanel expanded={expanded === 'panel1'} onChange={this.handleChange('panel1')}>
          ...
          <ExpansionPanelDetails>
            <Typography>
                ...
                <h3>Livrables</h3>
                <dl>
                    <dt><GradeIcon/><a href="/doc/EF/LivrableType_Dossier de faisabilité_V2.docx" >Etude de faisabilité</a></dt>
                    <dt><GradeIcon/><a href="/doc/EF/LivrableType_Dossier de faisabilité_Annexe_V1.pptx">CQQCOQP</a></dt>
                    <dt>Choix de la solution métier</dt>
                    <dt>Registre des parties prenantes</dt>
                    <dt>Pré-diagnostic de changement</dt>
                    <dt>Indicateurs de performance (en cours)</dt>
                    <dt>Lien vers le BABOK (en cours)</dt>
                </dl>
        ...
        <ExpansionPanel expanded={expanded === 'panel3'} onChange={this.handleChange('panel3')}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <Typography className={classes.heading}><h3>Chef de  projet</h3></Typography>
            <Typography className={classes.secondaryHeading}></Typography>
          </ExpansionPanelSummary>
          <ExpansionPanelDetails>
            <Typography>
            ...
            <h3>Livrables</h3>
                <dl>
                    <dt><GradeIcon/><a href="/doc/EF/" >Fiche d'identité projet</a></dt>
                </dl>
...
export default withStyles(styles)(Process2);
